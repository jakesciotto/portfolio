  ...
  'inline-flex items-center justify-center rounded-full border px-2.5 py-0.5 text-[10px] font-medium uppercase tracking-widest w-fit whitespace-nowrap shrink-0 transition-colors',
  {
    variants: {
      variant: {
        ...
        secondaryAccent:
          'text-accent-secondary border-accent-secondary/40 bg-accent-secondary/10',
        tertiary:
          'text-accent-tertiary border-accent-tertiary/40 bg-accent-tertiary/10',
        ...
        muted:
          'text-muted-foreground border-border-strong bg-secondary font-medium',
      },
    },
    defaultVariants: {
      variant: 'outline',
...
function Badge({ className, variant = 'outline', asChild = false, ...props }) {
