  ...
  return (
    <div>
      ...
      <ul className="list-disc pl-5 space-y-1 text-sm text-foreground/80">
        ...
        <li>
          coaching lacrosse &amp; bjj since 2009 - the nick saban
          of youth sports (self-appointed)
        </li>
        <li>
        ...
        <li>
          has two master&apos;s degrees - this debt is not going
          to pay for itself
        </li>
        <li>
          alumni mentor at johns hopkins - tough explaining my 7
          years in undergrad
        </li>
      </ul>
    </div>
